...
import 'package:mynotesapp/services/crud/crud_exeprions.dart';
...
class NotesService {
  ...
  Future<void> deleteNote({required int id}) async {
    ...
    if (deletedCount == 0) {
      ...
      _notes.removeWhere((note) => note.id == id);
      // if (_notes.length != countBefore) // probably it is the safer way
      _notesStreamController.add(_notes);
    }
  }
  ...
  Future<DatabaseNote> createNote({required DatabaseUser owner}) async {
    ...
    //make sure owner exists in the databese with the correct ID
  ...
  Future<void> open() async {
    ...
    try {
      ...
      throw UnableToGetDocumantionDirectory();
    }
  }
}
